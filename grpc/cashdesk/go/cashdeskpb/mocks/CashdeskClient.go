...
// SendEventAck provides a mock function with given fields: ctx, in, opts
func (_m *CashdeskClient) SendEventAck(ctx context.Context, in *cashdeskpb.SendEventAckRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *cashdeskpb.SendEventAckRequest, ...grpc.CallOption) (*emptypb.Empty, error)); ok {
		return rf(ctx, in, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *cashdeskpb.SendEventAckRequest, ...grpc.CallOption) *emptypb.Empty); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, *cashdeskpb.SendEventAckRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
...
// CashdeskClient_SendEventAck_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SendEventAck'
type CashdeskClient_SendEventAck_Call struct {
	*mock.Call
}

// SendEventAck is a helper method to define mock.On call
//   - ctx context.Context
//   - in *cashdeskpb.SendEventAckRequest
//   - opts ...grpc.CallOption
func (_e *CashdeskClient_Expecter) SendEventAck(ctx interface{}, in interface{}, opts ...interface{}) *CashdeskClient_SendEventAck_Call {
	return &CashdeskClient_SendEventAck_Call{Call: _e.mock.On("SendEventAck",
		append([]interface{}{ctx, in}, opts...)...)}
}

func (_c *CashdeskClient_SendEventAck_Call) Run(run func(ctx context.Context, in *cashdeskpb.SendEventAckRequest, opts ...grpc.CallOption)) *CashdeskClient_SendEventAck_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		run(args[0].(context.Context), args[1].(*cashdeskpb.SendEventAckRequest), variadicArgs...)
	})
	return _c
}

func (_c *CashdeskClient_SendEventAck_Call) Return(_a0 *emptypb.Empty, _a1 error) *CashdeskClient_SendEventAck_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *CashdeskClient_SendEventAck_Call) RunAndReturn(run func(context.Context, *cashdeskpb.SendEventAckRequest, ...grpc.CallOption) (*emptypb.Empty, error)) *CashdeskClient_SendEventAck_Call {
	_c.Call.Return(run)
	return _c
}
